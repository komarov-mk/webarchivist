// Проверяем, где выполняется скрипт — в попапе/контенте (есть window) или в бэкграунде (нет window)
if (typeof window !== 'undefined') {
    window.WebArchivistDebug = ["src/shared.js загружен"];
    console.log("[DEBUG 1/7] [Popup/Content] src/shared.js успешно применился.");
} else {
    console.log("[Background] src/shared.js успешно загружен в Service Worker.");
}
